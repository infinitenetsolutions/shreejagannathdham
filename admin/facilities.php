...
{
  $img = "SELECT * FROM `jag_facilities` WHERE 1";
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <div class="container-fluid">
            <div class="row mb-2">
              <div class="col-sm-6">
                <h1>Manage Temple Facilities</h1>
              </div>
              <div class="col-sm-6">
              ...
              <div class="card">
                ...
                <div class="card">
                  <div class="card-header">
                    <h3 class="card-title">Temple Facilities</h3>
                  </div>
                  <!-- /.card-header -->
                  <?php include 'add_facilities.php';
                        include 'update_legal.php';
                  // include 'update.php';
                  ?> 
               
                  <div class="card-body">
                  <a href="" class="btn btn-primary text-center" data-toggle="modal" data-target="#add_facilities" style="background:#e10d0d">Add New Facilities</a>
                      ...
                      <tbody>
                        ...
                        ?>
                            <tr>
                              ...
                              <td> <a href="delete_facilities.php?delete=<?php echo $rowimage['id']; ?>" class="btn btn-danger">Delete</a>
                            </tr>
                        <?php }  ?>
                      </tbody>
                      <tfoot>
