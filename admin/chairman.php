...
{
  $img = "SELECT * FROM `jag_chairman` WHERE 1";
            ...
            <div class="col-12">
              <div class="card">
                ...
                <div class="card">
                  ...
                  <!-- /.card-header -->
                  <?php include 'add_chairman.php';
                        include 'update_legal.php';
                  // include 'update.php';
                  ?> 
               
                  <div class="card-body">
                  <a href="" class="btn btn-primary text-center" data-toggle="modal" data-target="#add_chairman" style="background:#e10d0d">Add New Chairman</a>
                      ...
                      <tbody>
                        ...
                        ?>
                            <tr>
                              ...
                              <td><a href="update_chairman.php?edit=<?php echo $rowimage['id']; ?>" class="btn btn-warning">Update</a>
                              <td> <a href="delete_chairman.php?delete=<?php echo $rowimage['id']; ?>" class="btn btn-danger">Delete</a>
                            </tr>
                        <?php 
                        $cnt++;
                        }  ?>
