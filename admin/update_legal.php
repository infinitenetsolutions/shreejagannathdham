...
<div class="modal fade" id="update_legal<?php echo $rowimage['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <form action="" method="POST" enctype="multipart/form-data">
                <div class="modal-header text-center">
                    <h4 class="modal-title w-100 font-weight-bold">Update Legal Documents</h4>
                ...
                <div class="modal-body mx-3">
                    ...
                    <div class="form-group">
                        <label class="a-color" for="exampleFormControlSelect1">Existing Document</label>
                        <img height="100px" width="100px" <?php echo ' src="data:image/jpeg;base64,' . base64_encode($row['images']) . '"' ?> class="img-fluid mb-2" alt="Legal Doc" />
                    </div>
                    <div class="form-group">
                        <label class="a-color" for="exampleFormControlSelect1">Enter Title</label>
                        <input name="title" type="text" class="form-control" id="exampleFormControlSelect1" value="<?php echo $rowimage['title']; ?>">
                    </div>
                    <div class="form-group">
