  ...
  $description = simplename($_POST['description']);
      if ($cat != null) {
        ...
        //     if (is_uploaded_file($_FILES['Image']['tmp_name'])) {
                ...
                $sql = "INSERT INTO `jag_facilities`(`title`,`description`,`image`) VALUES ('$title','$description','$imgData')";
                ...
                if ($current_id) {
                    ...
                    echo "<script>
                    setTimeout(function() {
                        window.location.replace('facilities.php');
...
$select1 = "SELECT * FROM `jag_facilities`";
$result2 = mysqli_query($connection, $select1);


?>

<div class="modal fade" id="add_facilities" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content" style="background: #e7cb44;">
            <form action="" method="POST" enctype="multipart/form-data">
                <div class="modal-header text-center">
                    <h4 class="modal-title w-100 font-weight-bold" style="color: #f72000;"><u>Add Temple Facilities</u></h4>
