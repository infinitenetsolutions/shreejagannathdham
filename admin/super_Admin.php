...
if (isset($_POST['done'])) {
    ...
    // echo $password;
    $q = "SELECT * FROM `super_admin` WHERE `user_name`='$username' || `email_id`='$email'";
                                  ...
                                  <br>
                                    <div class="foot">
                                        <footer class="main-footer text-white">
                                            <strong>Copyright &copy; <?php echo date('Y') ?> <a class="text-danger" href="#">Shree Jagannathdham Trust</a>.</strong>
                                            All rights reserved.
